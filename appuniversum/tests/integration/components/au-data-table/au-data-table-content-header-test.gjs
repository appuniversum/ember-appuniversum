...
import AuDataTableContentHeader from '#src/components/au-data-table/content-header.gjs';
...
module(
  ...
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      await render(<template><AuDataTableContentHeader /></template>);
    ...
    test('display column headers', async function (assert) {
      ...
      await render(
        <template>
          <AuDataTableContentHeader @data-table={{dataTable}} />
        </template>,
      );
