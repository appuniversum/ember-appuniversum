...
| `@size` | Pass the svg name to select the icon | `default` / `medium` / `large` | `default` |
| `@alignment` | Add margin to the icon | `left` / `right` | - |
| `@ariaHidden` | Add margin to the icon | `boolean` | `true` |
