/*! For license information please see chunk.142.b567ca3423d9aeb7a963.js.LICENSE.txt */
(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[142],{3997:(e,t,n)=>{"use strict"
n.r(t),n.d(t,{arrow:()=>Re,autoPlacement:()=>Ce,autoUpdate:()=>Oe,computePosition:()=>Be,detectOverflow:()=>Te,flip:()=>Me,getOverflowAncestors:()=>le,hide:()=>De,inline:()=>Le,limitShift:()=>Fe,offset:()=>Ae,platform:()=>_e,shift:()=>Ie,size:()=>je})
...
function w(e){return y.has(m(e))?"y":"x"}function k(e){return v(w(e))}function P(e,t,n){void 0===n&&(n=!1)
const r=g(e),i=k(e),o=b(i)
let s="x"===i?r===(n?"end":"start")?"right":"left":"start"===r?"bottom":"top"
return t.reference[o]>t.floating[o]&&(s=T(s)),[s,T(s)]}function S(e){return e.replace(/start|end/g,(e=>h[e]))}const x=["left","right"],_=["right","left"],E=["top","bottom"],O=["bottom","top"]
function T(e){return e.replace(/left|right|bottom|top/g,(e=>d[e]))}function A(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function C(e){const{x:t,y:n,width:r,height:i}=e
...
return null==(t=(z(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function z(e){return!!F()&&(e instanceof Node||e instanceof N(e).Node)}function U(e){return!!F()&&(e instanceof Element||e instanceof N(e).Element)}function V(e){return!!F()&&(e instanceof HTMLElement||e instanceof N(e).HTMLElement)}function q(e){return!(!F()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof N(e).ShadowRoot)}const W=new Set(["inline","contents"])
function K(e){const{overflow:t,overflowX:n,overflowY:r,display:i}=ie(e)
return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&!W.has(i)}const G=new Set(["table","td","th"])
...
function ee(e){const t=te(),n=U(e)?ie(e):e
...
function re(e){return ne.has(B(e))}function ie(e){return N(e).getComputedStyle(e)}function oe(e){return U(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function se(e){if("html"===B(e))return e
const t=e.assignedSlot||e.parentNode||q(e)&&e.host||H(e)
return q(t)?t.host:t}function ae(e){const t=se(e)
return re(t)?e.ownerDocument?e.ownerDocument.body:e.body:V(t)&&K(t)?t:ae(t)}function le(e,t,n){var r
...
const i=V(e),o=i?e.offsetWidth:n,s=i?e.offsetHeight:r,a=l(n)!==o||l(r)!==s
return a&&(n=o,r=s),{width:n,height:r,$:a}}function de(e){return U(e)?e:e.contextElement}function he(e){const t=de(e)
if(!V(t))return u(1)
...
if(o){const e=N(o),t=r&&U(r)?N(r):r
let n=e,i=ce(n)
...
l*=e.x,c*=e.y,d*=e.x,h*=e.y,l+=o,c+=s,n=N(i),i=ce(n)}}return C({width:d,height:h,x:l,y:c})}function ge(e,t){const n=oe(e).scrollLeft
...
else if(U(t))r=function(e,t){const n=me(e,!0,"fixed"===t),r=n.top+e.clientTop,i=n.left+e.clientLeft,o=V(e)?he(e):u(1)
return{width:e.clientWidth*o.x,height:e.clientHeight*o.y,x:i*o.x,y:r*o.y}}(t,n)
else{const n=fe(e)
r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return C(r)}function we(e,t){const n=se(e)
return!(n===t||!U(n)||re(n))&&("fixed"===ie(n).position||we(n,t))}function ke(e,t,n){const r=V(t),i=H(t),o="fixed"===n,s=me(e,!0,o,t)
...
return{x:s.left+a.scrollLeft-l.x-d.x,y:s.top+a.scrollTop-l.y-d.y,width:s.width,height:s.height}}function Pe(e){return"static"===ie(e).position}function Se(e,t){if(!V(e)||"fixed"===ie(e).position)return null
if(t)return t(e)
let n=e.offsetParent
return H(e)===n&&(n=n.ownerDocument.body),n}function xe(e,t){const n=N(e)
if(Q(e))return n
if(!V(e)){let t=se(e)
for(;t&&!re(t);){if(U(t)&&!Pe(t))return t
t=se(t)}return n}let r=Se(e,t)
for(;r&&$(r)&&Pe(r);)r=Se(r,t)
return r&&re(r)&&Pe(r)&&!ee(r)?n:r||function(e){let t=se(e)
for(;V(t)&&!re(t);){if(ee(t))return t
if(Q(t))return null
...
const d=u(0),h=V(r)
if((h||!h&&!o)&&(("body"!==B(r)||K(s))&&(l=oe(r)),V(r))){const e=me(r)
...
if(n)return n
let r=le(e,[],!1).filter((e=>U(e)&&"body"!==B(e))),i=null
const o="fixed"===ie(e).position
let s=o?se(e):e
for(;U(s)&&!re(s);){const t=ie(s),n=ee(s)
...
return{width:t,height:n}},getScale:he,isElement:U,isRTL:function(e){return"rtl"===ie(e).direction}}
...
p.forEach((e=>{i&&e.removeEventListener("scroll",n),o&&e.removeEventListener("resize",n)})),null==f||f(),null==(e=v)||e.disconnect(),v=null,d&&cancelAnimationFrame(m)}}const Te=M,Ae=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var n,r
...
return s===(null==(n=a.offset)?void 0:n.placement)&&null!=(r=a.arrow)&&r.alignmentOffset?{}:{x:i+l.x,y:o+l.y,data:{...l,placement:s}}}}},Ce=function(e){return void 0===e&&(e={}),{name:"autoPlacement",options:e,async fn(t){var n,r,i
const{rects:s,middlewareData:a,placement:l,platform:c,elements:u}=t,{crossAxis:d=!1,alignment:h,allowedPlacements:p=o,autoAlignment:v=!0,...b}=f(e,t),y=void 0!==h||p===o?function(e,t,n){return(e?[...n.filter((t=>g(t)===e)),...n.filter((t=>g(t)!==e))]:n.filter((e=>m(e)===e))).filter((n=>!e||g(n)===e||!!t&&S(n)!==n))}(h||null,v,p):p,w=await M(t,b),k=(null==(n=a.autoPlacement)?void 0:n.index)||0,x=y[k]
if(null==x)return{}
const _=P(x,s,await(null==c.isRTL?void 0:c.isRTL(u.floating)))
...
const A=O.map((e=>{const t=g(e.placement)
return[e.placement,t&&d?e.overflows.slice(0,2).reduce(((e,t)=>e+t),0):e.overflows[0],e.overflows]})).sort(((e,t)=>e[1]-t[1])),C=(null==(i=A.filter((e=>e[2].slice(0,g(e[0])?2:3).every((e=>e<=0))))[0])?void 0:i[0])||A[0][0]
return C!==l?{data:{index:k+1,overflows:O},reset:{placement:C}}:{}}}},Ie=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:n,y:r,placement:i}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:a={fn:e=>{let{x:t,y:n}=e
...
const k=m(i),A=w(a),C=m(a)===a,I=await(null==l.isRTL?void 0:l.isRTL(c.floating)),j=h||(C||!b?[T(a)]:function(e){const t=T(e)
return[S(e),t,S(t)]}(a)),D="none"!==v
...
return i&&(o=o.map((e=>e+"-"+i)),t&&(o=o.concat(o.map(S)))),o}(a,b,v,I))
const R=[a,...j],L=await M(t,y),F=[]
let B=(null==(r=o.flip)?void 0:r.overflows)||[]
if(u&&F.push(L[k]),d){const e=P(i,s,I)
F.push(L[e[0]],L[e[1]])}if(B=[...B,{placement:i,overflows:F}],!F.every((e=>e<=0))){var N,H
const e=((null==(N=o.flip)?void 0:N.index)||0)+1,t=R[e]
if(t&&("alignment"!==d||A===w(t)||B.every((e=>w(e.placement)!==A||e.overflows[0]>0))))return{data:{index:e,overflows:B},reset:{placement:t}}
...
return t===A||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:z[0]
e&&(n=e)
...
let P,S
"top"===p||"bottom"===p?(P=p,S=v===(await(null==l.isRTL?void 0:l.isRTL(c.floating))?"start":"end")?"left":"right"):(S=p,P="end"===v?"top":"bottom")
const x=k-h.top-h.bottom,_=y-h.left-h.right,E=s(k-h[P],x),O=s(y-h[S],_),T=!t.middlewareData.shift
let A=E,C=O
if(null!=(n=t.middlewareData.shift)&&n.enabled.x&&(C=_),null!=(r=t.middlewareData.shift)&&r.enabled.y&&(A=x),T&&!v){const e=a(h.left,0),t=a(h.right,0),n=a(h.top,0),r=a(h.bottom,0)
b?C=y-2*(0!==e||0!==t?e+t:a(h.left,h.right)):A=k-2*(0!==n||0!==r?n+r:a(h.top,h.bottom))}await u({...t,availableWidth:C,availableHeight:A})
...
if(null==u)return{}
const h=A(d),m={x:n,y:r},v=k(i),y=b(v),w=await a.getDimensions(u),P="y"===v,S=P?"top":"left",x=P?"bottom":"right",_=P?"clientHeight":"clientWidth",E=o.reference[y]+o.reference[v]-m[v]-o.floating[y],O=m[v]-o.reference[v],T=await(null==a.getOffsetParent?void 0:a.getOffsetParent(u))
let C=T?T[_]:0
C&&await(null==a.isElement?void 0:a.isElement(T))||(C=l.floating[_]||o.floating[y])
const I=E/2-O/2,M=C/2-w[y]/2-1,j=s(h[S],M),D=s(h[x],M),R=j,L=C-w[y]-D,F=C/2-w[y]/2+I,B=p(R,F,L),N=!c.arrow&&null!=g(i)&&F!==B&&o.reference[y]/2-(F<R?j:D)-w[y]/2<0,H=N?F<R?F-R:F-L:0
...
!r||e.y-r.y>r.height/2?n.push([e]):n[n.length-1].push(e),r=e}return n.map((e=>C(R(e))))}(h),g=C(R(h)),v=A(c),b=await o.getElementRects({reference:{getBoundingClientRect:function(){if(2===p.length&&p[0].left>p[1].right&&null!=u&&null!=d)return p.find((e=>u>e.left-v.left&&u<e.right+v.right&&d>e.top-v.top&&d<e.bottom+v.bottom))||g
...
p<t?p=t:p>n&&(p=n)}if(c){var k,P
const e="y"===h?"width":"height",t=L.has(m(i)),n=o.reference[d]-o.floating[e]+(t&&(null==(k=s.offset)?void 0:k[d])||0)+(t?0:y.crossAxis),r=o.reference[d]+o.reference[e]+(t?0:(null==(P=s.offset)?void 0:P[d])||0)-(t?y.crossAxis:0)
