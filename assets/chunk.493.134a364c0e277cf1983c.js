/*! For license information please see chunk.493.134a364c0e277cf1983c.js.LICENSE.txt */
"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[493],{5493(e,t,s){s.d(t,{scopeCss:()=>C})
...
e=W(e,e=>"@"!==e.selector[0]?t(e):e.selector.startsWith("@media")||e.selector.startsWith("@supports")||e.selector.startsWith("@page")||e.selector.startsWith("@document")?(e.content=W(e.content,t),e):e)}const b=((e,t,s,n)=>{const h=((e,t)=>{const s="."+t+" > ",r=[]
...
return e=(e=>u.reduce((e,t)=>e.replace(t," "),e))(e=h.cssText),t&&(e=T(e,t,s,n)),{cssText:(e=(e=e.replace(/-shadowcsshost-no-combinator/g,`.${s}`)).replace(/>\s*\*\s+([^{, ]+)/gm," $1 ")).trim(),slottedSelectors:h.selectors}})(e,t,n,h)
